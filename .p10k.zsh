...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status (newline baked into prefix)
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  # Default background color (Catppuccin Surface1).
  typeset -g POWERLEVEL9K_BACKGROUND=238

  # Separator between same-color segments on the left.
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%248F\uE0B1'
  ...
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=189
  # Custom icon.
  ...
  # Catppuccin Mocha: Lavender for directory path
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Color branch name yellow if there are any dirty changes, green if clean.
      local branch_color=$clean
      (( VCS_STATUS_NUM_STAGED + VCS_STATUS_NUM_UNSTAGED + VCS_STATUS_NUM_UNTRACKED + VCS_STATUS_NUM_CONFLICTED > 0 )) && branch_color=$modified
  ...
  # Catppuccin Mocha: Green for clean, Peach for modified, Lavender for untracked
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=114
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=183
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=209
  ...
  # Catppuccin Mocha: Red/Maroon for errors
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=189
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  # Catppuccin Mocha: Sky for k8s context
